...
void hal_entry (void)
{
    ...
    while (1)
    {
        ...
        uint32_t pin3 = leds.p_leds[3];
                   uint32_t pin4 = leds.p_leds[4];
                   uint32_t pin5 = leds.p_leds[5];

                   R_BSP_PinWrite((bsp_io_port_pin_t)pin3, BSP_IO_LEVEL_HIGH);
                   R_BSP_PinWrite((bsp_io_port_pin_t)pin4, BSP_IO_LEVEL_HIGH);
                   R_BSP_PinWrite((bsp_io_port_pin_t)pin5, BSP_IO_LEVEL_HIGH);
